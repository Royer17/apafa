            ...
            <div class="card-body">
                <div id="externo_1">
                    <div class="form-group row">
                        ...
                        <input type="text" value="{{ $user->entity->identity_document }}" class="form-control form-control-sm externo-1" placeholder="" aria-describedby="buscar_dni_bt" required="" disabled>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="nombre_field" class="col col-lg-2 col-md-6 col-sm-4 col-12">Nombres</label>
                        <div class="col col-lg-4 col-md-6 col-sm-8 col-12" style="padding: 0px;">
                        <input type="text" value="{{ $user->entity->name }}" class="form-control form-control-sm externo-1 text-uppercase" placeholder="" disabled>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="apelpa_field" class="col col-lg-2 col-md-6 col-sm-4 col-12">Apellido paterno</label>
                        <div class="col col-lg-4 col-md-6 col-sm-8 col-12" style="padding: 0px;">
                        <input type="text" value="{{ $user->entity->paternal_surname }}" class="form-control form-control-sm externo-1 text-uppercase" placeholder="" disabled>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="apelma_field" class="col col-lg-2 col-md-6 col-sm-4 col-12">Apellido materno</label>
                        <div class="col col-lg-4 col-md-6 col-sm-8 col-12" style="padding: 0px;">
                        <input type="text" value="{{ $user->entity->maternal_surname }}" class="form-control form-control-sm externo-1 text-uppercase" placeholder="" disabled>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col col-lg-4 col-md-6 col-sm-8 col-12" style="padding: 0px;">
                        <input type="text" value="{{ $user->entity->cellphone }}" class="form-control form-control-sm text-uppercase" placeholder="" disabled>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col col-lg-4 col-md-6 col-sm-8 col-12" style="padding: 0px;">
                        <input type="email" value="{{ $user->entity->email }}" class="form-control form-control-sm text-uppercase" placeholder="" disabled>
                    </div>
                </div>
